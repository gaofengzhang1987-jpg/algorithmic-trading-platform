...
REGIME_WEIGHTS = {
    ...
    "二买": {
        ...
        "CHOP": {"量比": 2.51, "相对强度": 2.11, "MACD": 1.97, "前低防守距离": 0.71, "底分型": 0.45, "时间消化": 0.14},
    },
    "三买": {
        "BEAR": {"核心验证": 1.12, "量比": 0.05, "MACD": 1.08, "笔数": 1.68, "底分型": 1.96},
        "BULL": {"核心验证": 1.07, "量比": 0.26, "MACD": 1.99, "笔数": 1.45, "底分型": 0.48},
        "CHOP": {"ZG站稳天数": 2.83, "中枢质量": 2.26, "时间消化": 1.73, "ATR扩张比": 1.66, "MACD": 1.39, "回抽深度": 0.95, "突破量持续性": 0.80, "底分型": 0.13, "相对强度": 0.07},
    },
}

REGIME_THRESHOLDS = {
    "一买": {"BEAR": 255, "BULL": 999, "CHOP": 252},
    "二买": {"BEAR": 273, "BULL": 327, "CHOP": 514},
    "三买": {"BEAR": 999, "BULL": 366, "CHOP": 964},
}
