...
REGIME_WEIGHTS = {
    "一买": {
        "BEAR": {"底部放量": 1.84, "MACD": 1.79, "量比": 1.53, "核心验证": 1.13, "笔数": 0.83, "中枢": 0.6, "底分型": 0.37},
    ...
    "二买": {
        "BEAR": {"量比": 1.96, "底分型": 1.1, "核心验证": 0.74, "MACD": 0.2},
    ...
    "三买": {
        ...
        "BULL": {"MACD": 2.86, "笔数": 2.83, "MA排列强度": 1.69, "核心验证": 0.17, "底分型": 0.1},
...
REGIME_THRESHOLDS = {
    "一买": {"BEAR": 418, "BULL": 999, "CHOP": 792},
    "二买": {"BEAR": 259, "BULL": 289, "CHOP": 544},
    "三买": {"BEAR": 999, "BULL": 688, "CHOP": 1000},
}
