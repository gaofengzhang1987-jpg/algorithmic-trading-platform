...
REGIME_WEIGHTS = {
    "一买": {
        ...
        "CHOP": {"成交量萎缩": 0.72, "前期跌幅": 0.71, "相对强度": 0.10, "量比": 0.70, "底分型": 0.23, "区间位置": 0.18, "中枢": 0.12, "时间消化": 0.72, "距离": 1.96, "波动压缩": 0.57, "MACD": 0, "核心验证": 0.12},
    },
    "二买": {
        "BEAR": {"核心验证": 1.68, "量比": 0.00, "MACD": 1.57, "笔数": 1.00, "底分型": 0.78},
        "BULL": {"核心验证": 2.11, "量比": 0.16, "MACD": 1.38, "笔数": 1.28, "底分型": 1.61},
        "CHOP": {"量比": 2.29, "相对强度": 1.42, "MACD": 1.39, "时间消化": 1.29, "前低防守距离": 1.02, "底分型": 0.52, "二次放量启动": 0.14},
    },
    "三买": {
        "BEAR": {"核心验证": 1.12, "量比": 0.05, "MACD": 1.08, "笔数": 1.68, "底分型": 1.96},
        "BULL": {"核心验证": 1.07, "量比": 0.26, "MACD": 1.99, "笔数": 1.45, "底分型": 0.48},
        "CHOP": {"中枢质量": 2.01, "MACD": 1.05, "ATR扩张比": 0.74, "ZG站稳天数": 0.62, "回抽深度": 0.38, "时间消化": 0.30, "突破量持续性": 0.20, "相对强度": 0.12, "底分型": 0.07},
    },
}

REGIME_THRESHOLDS = {
    "一买": {"BEAR": 255, "BULL": 999, "CHOP": 252},
    "二买": {"BEAR": 273, "BULL": 327, "CHOP": 515},
    "三买": {"BEAR": 999, "BULL": 366, "CHOP": 420},
}
